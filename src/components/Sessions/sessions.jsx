      ...
      <div className="session-1">
        <div className="session-1-text">
          ...
          <p className="session-1-subtext">
            ...
            programmes like GSoC and Summer of Bitcoin. We'll wrap up Open Source
            Takeover with a beginner-friendly Introduction to Github, in
      ...
      <div className="session-2">
        ...
        <div className="session-2-text">
          ...
          <p className="session-2-subtext">
            After you have the fine knowledge imparted from Open Source Takeover, Git.Set.Go will help you cover the topics of Git and we
